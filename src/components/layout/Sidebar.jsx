...
export default function Sidebar() {
  return (
    <aside className="w-64 h-screen bg-vybe-surface border-r border-vybe-glassBorder flex flex-col fixed left-0 top-0">
      {/* Logo Area */}
      ...
      <div className="p-4 border-t border-vybe-glassBorder">
        <div className="flex items-center gap-3 px-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-vybe-neon to-green-600 flex items-center justify-center text-black font-bold text-sm">
            A
          </div>
