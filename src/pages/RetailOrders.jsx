  ...
  const handleDownloadInvoice = () => {
    ...
    html2canvas(elementToBeCaptured, options)
      .then((canvas) => {
        ...
        link.href = url;
        link.download = `Invoice_${selectedOrder.id}.pdf`;
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', paddingBottom: '48px' }}>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="invoice" type="primary" onClick={handleDownloadInvoice} icon={<FileText size={16} />} style={{ fontWeight: 600, color: '#000' }}>
            Download Invoice
          </Button>
        ]}
        width={900}
      ...
      >
        {selectedOrder && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            {/* Hidden component for capturing invoice */}
